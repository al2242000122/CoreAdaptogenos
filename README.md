...
- El WhatsApp Business público de ambas marcas es **220 644 6651** (`https://wa.me/522206446651`). El pie del frontend enlaza a este contacto solo cuando se configura WooCommerce con un catálogo real. `VITE_WHATSAPP_NUMBER` sigue vacío en el prototipo: configúralo como `522206446651` únicamente al publicar un catálogo real, para no enviar pedidos de productos ficticios. Si falta o no cumple el formato, la acción de pedido permanece oculta y se ofrece “Copiar pedido”. La persona revisa el mensaje antes de abrir WhatsApp y decide si lo envía.
