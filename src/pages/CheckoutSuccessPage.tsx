...
export function CheckoutSuccessPage() {
  ...
  return <>
    <header className="checkout-intro"><p className="eyebrow">Recorrido completo / 03</p><h1>Simulación completada</h1><p>El prototipo no guardó ni transmitió los datos de este formulario, ni creó pedidos o pagos. El navegador puede conservar datos del formulario en su historial aunque el autocompletado esté desactivado. Tu selección sigue en el carrito.</p></header>
